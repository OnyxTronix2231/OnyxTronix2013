...
public class CenterByVision extends Command {
	...
	private boolean hasStartedOnTarget = false;
	
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public CenterByVision(double setpoint, int numberOfParticles) {
    ...
    protected void initialize() {
		...
		RobotMap.visionSensor.startProcessing(PIDVisionSourceType.NormalizedDistanceFromCenter, m_numberOfParticles);
