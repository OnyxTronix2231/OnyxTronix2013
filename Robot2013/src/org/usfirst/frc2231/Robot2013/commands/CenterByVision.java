...
public class CenterByVision extends Command {
    ...
    protected void initialize() {
    	...
    	Robot.vision.changeTalonControlModeRotate(TalonControlMode.Follower);
    	Robot.vision.setTalonsReversedState(true);
    ...
    */
    ...
    protected boolean isFinished() {
		...
		System.out.println("Drive train, controlmode: " + RobotMap.driveTrainSecondLeft.getControlMode() + " , " + RobotMap.driveTrainSecondRight.getControlMode());
		System.out.println("Drive train, controlmode: " + RobotMap.driveTrainFirstLeft.getControlMode() + " , " + RobotMap.driveTrainFirstRight.getControlMode());
...
//    	return RobotMap.VisionLeftPIDController.onTarget() && RobotMap.VisionRightPIDController.onTarget();
    	...
    	*/
    	...
    	return Math.abs(RobotMap.VisionLeftPIDController.getError()) < StaticMembers.ABSOLUTE_TOLERANCE &&
    			Math.abs(RobotMap.VisionRightPIDController.getError()) < StaticMembers.ABSOLUTE_TOLERANCE;    	
    ...
    protected void end() {
    	...
    	Robot.vision.setTalonsReversedState(false);
    	Robot.vision.changeTalonControlModeRotate(TalonControlMode.PercentVbus);
