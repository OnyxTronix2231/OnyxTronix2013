...
public class DriveForwardByVision extends Command {
	...
	public DriveForwardByVision(double setPoint,int numberOfParticles) {
	...
	protected void initialize(){
		...
		RobotMap.visionSensor.startProcessing(PIDVisionSourceType.DistanceFromTarget, m_numberOfParticles);
		hasStartedOnTarget = RobotMap.VisionDistanceLeftPIDController.init(m_setPoint, StaticMembers.ABSOLUTE_TOLERANCE_DISTANCE)
		 					&& RobotMap.VisionDistanceRightPIDController.init(m_setPoint, StaticMembers.ABSOLUTE_TOLERANCE_DISTANCE);
	}
	...
	protected boolean isFinished() {
		return RobotMap.VisionDistanceLeftPIDController.onTarget() && RobotMap.VisionDistanceRightPIDController.onTarget() || !hasStartedOnTarget;
	}
