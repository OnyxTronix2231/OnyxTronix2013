...
public class Vision extends Subsystem implements PIDSource{
	...
	protected double distanceFromCenter = 23;
    ...
    public long lastDistanceRefresh = 0; 
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
    	//System.out.println("requirements: " + (new ProcessImage()).doesRequire(Robot.vision));
//    	setDefaultCommand(new ProcessImage());
	...
	public double getRate() {
    	...
    	if(distance < 1.44 || distance > 5.015){
    		...
    		return 29.1078 * Math.pow(Math.E, 0.1747 * distance); 
    	} 
...
//			System.out.println("processImage: " + processImage);
...
//			System.out.println("processImage: " + processImage + "binaryImage: " + processImage);
...
//		System.out.println("particle report: " + particleReport + ", PID Source Type: " + pidSourceType);
		...
		case kDisplacement:
			try {
				...
				lastDistanceRefresh = System.currentTimeMillis();
