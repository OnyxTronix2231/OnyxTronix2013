...
public class OI {
    ...
    public JoystickButton drive10CM;
    ...
    public OI() {
        ...
        drive10CM = new JoystickButton(buttonStick, 1);
        drive10CM.whenPressed(new DriveByDistance(0));
        shoot = new JoystickButton(buttonStick, 6);
