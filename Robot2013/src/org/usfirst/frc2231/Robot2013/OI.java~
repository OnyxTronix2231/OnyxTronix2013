...
import org.usfirst.frc2231.Robot2013.commands.PrintVisionDistance;
...
public class OI {
    ...
    public JoystickButton printVisionDistance;
    ...
    public OI() {
        ...
        printVisionDistance = new JoystickButton(buttonStick, 5);
        printVisionDistance.whileHeld(new PrintVisionDistance());
        shootByVision = new JoystickButton(buttonStick, 6);
        ...
        SmartDashboard.putData("PrintVisionDistance", new PrintVisionDistance());
